...
```python
# 必要なパッケージをインストール
!pip install -e /path/to/deep_research_tool2

# または、パスを追加
import sys
sys.path.insert(0, '/path/to/deep_research_tool2')
```
...
```python
from deep_research_tool2 import DeepResearchTool
...
```python
from deep_research_tool2.verification import Verifier
...
```python
from deep_research_tool2.evidence import EvidenceLocker
