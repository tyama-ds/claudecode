...
from deep_research_tool2.config import Config, create_config, LLMProvider, SearchMethod
from deep_research_tool2.evidence import EvidenceLocker, Evidence, EvidenceType
from deep_research_tool2.research.query_generator import QueryGenerator, ResearchPlan, TableOfContents
from deep_research_tool2.research.content_extractor import ContentExtractor, ExtractedContent
from deep_research_tool2.research.researcher import Researcher, ResearchSession, ResearchState
from deep_research_tool2.verification import Verifier, VerificationResult, ClaimVerification
from deep_research_tool2.report import ReportGenerator, ReportFormat
from deep_research_tool2.search import DuckDuckGoSearch, SearchResult
from deep_research_tool2.utils import DocumentReader, truncate_text, chunk_text
...
class TestQueryGenerator:
    ...
    def test_generate_follow_up_queries_with_mock(self):
        ...
        from deep_research_tool2.research.query_generator import TableOfContentsItem
...
class TestReportGenerator:
    ...
    def test_generate_docx_with_quality_filtering(self):
        ...
        with tempfile.TemporaryDirectory() as tmpdir:
            from deep_research_tool2.evidence.locker import QualityCategory, SourceType
