...
- 「結論：」「要点：」「ポイント：」「概要：」のようなラベルを本文に書かない。細切れの短文を並べず、3〜5文のまとまった段落として論じ、段落同士を接続表現でつなぐ。
- レポート全体を通して一人の書き手が書いたような、統一された文体・調子を保つ。
    ...
    def get_style_instructions(self) -> str:
        ...
        style_map = {
            ...
            WritingStyle.BUSINESS: (
                "ビジネス報告書の文体。「です・ます」調で統一。各段落は最も重要な内容から"
                "自然に書き始め、根拠を続ける（「結論：」のようなラベルは書かず、"
                "通常の文章として述べる）。"
                "「〜について見ていきましょう」のような話し言葉・講義調は使わない。"
                f"{prose_rule}"
            ),
            ...
            WritingStyle.EXECUTIVE: (
                "経営層向け。「です・ます」調。各段落は要点から自然に書き始め、"
                "根拠と示唆を続ける（「要点：」のようなラベルは書かない）。"
