"""
Configuration management for Information Gathering Agent.
...
class MultilingualSearchConfig:
    ...
    # Include language statistics in output
...
def create_config(
    ...
    **kwargs
    ...
    Args:
        ...
        max_queries_per_iteration: Max queries per research iteration
        max_pages_per_query: Max pages to process per search query
        ...
        export_evidence_csv: Export evidence as CSV
        export_evidence_json: Export evidence as JSON
    ...
    return Config(
        ...
        export_evidence_csv=export_evidence_csv,
        export_evidence_json=export_evidence_json,
        verbose=verbose,
    )
